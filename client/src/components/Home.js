    ...
    <div className='bg' style={{
      ...
      <section id="game-list" className="hl-games-list hl-item">
        <div className="hl-item-inner" >
          ...
          <div className="hl-games-list-item">
            <div className="img-bg">
              <img src="https://cdn.imgbin.com/24/24/2/imgbin-league-of-legends-electronic-sports-legacy-esports-pty-limited-player-league-of-legends-e6g009zLZUBPBWg8B5uAigahK.jpg" alt="Game"></img>
            </div>
          </div>
          <div className="hl-games-list-item">
            <div className="img-bg">
              <img src="https://www.pngfind.com/pngs/m/503-5039968_lgd-png-download-player-transparent-png.png" alt="Game"></img>
            </div>
          </div>
          <div className="hl-games-list-item">
            <div className="img-bg">
              <img src="https://images.squarespace-cdn.com/content/v1/589bff0c414fb513e704c6e9/1633339929071-Y6VF294WJH8L5NP56W5M/IMG_7789.jpeg" alt="Game"></img>
            </div>
          </div>
        </div>
      </section>
